...
export const formSchema = z.object({
  ...
  topnode: z.string().min(1, {
    message: "Top node is required."
  }),
  amount: z.string().min(1),
  topdrop: z.string().min(1)
});
...
export const topNodeOptions = [
  {
    value: " ",
    label: "Describe Your Own Top Node"
  },
  {
    value: "Data Breach",
    label: "Use Example: Data Breach"
  },
  {
    value: "Denial of service",
    label: "Use Example: DoS"
  }
];
